          ...
          >
            {provider.name === 'Google' ? (
              <button
                ...
                className='flex w-full place-content-center h-1id2 items-center py-2 bg-slate-300 text-white text-md leading-tight capitalize text-xl rounded-full shadow-md hover:bg-slate-700 hover:text-white hover:shadow-lg focus:bg-slate-700 focuss:hadow-lg focus:outline-none focus:ring-0 active:bg-salte-800 active:shadow-lg transition duration-150 ease-in-out'
              >
