const LoginForm = () => {
  return <>
    ...
    <div className='text-center lgtext-left w-full'>
      <button
        type='submit'
        className='inline-block px-48 py-3 bg-blue-500 text-white font-medium text-sm leading-snug uppercase rounded shadow-md bg-blue-400 hover:bg-blue-500 hover:shadow-lg focusbg-blue-700 focusshadow-lg focusoutline-none focusring-0 activebg-blue-800 activeshadow-lg transition duration-150 ease-in-out w-full'
      >
        Login
      </button>
